...
import { normalApproximationBinomialFrenchLanguageVariantAgent } from '../agents/normalApproximationBinomialFrenchLanguageVariantAgent';
...
import { normalApproximationBinomialProblemSchema } from '../../problem-bank/schemas/normalApproximationBinomial.schema';
...
const generatedVariantsWithCanonicalProblemSchema = z.object({
  canonicalProblem: normalApproximationBinomialProblemSchema,
...
const generateLanguageVariantsStep = createStep({
  id: 'generate-normal-approximation-binomial-french-language-variants',

  inputSchema: normalApproximationBinomialProblemSchema,
...
`;
    ...
    const response =
      await normalApproximationBinomialFrenchLanguageVariantAgent.generate(
        prompt,
        {
          structuredOutput: {
...
const validateMathInvariantsStep = createStep({
  id: 'validate-normal-approximation-binomial-french-math-invariants',
...
const evaluateRegisterStep = createStep({
  id: 'evaluate-normal-approximation-binomial-french-register',
...
const computeReadabilityMetricsStep = createStep({
  id: 'compute-normal-approximation-binomial-french-readability-metrics',
...
const assessReadabilityTargetsStep = createStep({
  id: 'assess-normal-approximation-binomial-french-readability-targets',
...
export const generateNormalApproximationBinomialFrenchVariantsWorkflow =
  createWorkflow({
    id: 'generate-normal-approximation-binomial-french-variants',
    inputSchema: normalApproximationBinomialProblemSchema,
    outputSchema: workflowOutputSchema,
  })
