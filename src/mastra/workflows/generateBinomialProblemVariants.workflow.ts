...
import { languageVariantAgent } from '../agents/binomialLanguageVariantAgent';
...
const generateLanguageVariantsStep = createStep({
  id: 'generate-binomial-language-variants',
...
const validateMathInvariantsStep = createStep({
  id: 'validate-binomial-math-invariants',
...
const computeReadabilityMetricsStep = createStep({
  id: 'compute-binomial-readability-metrics',
...
const assessReadabilityTargetsStep = createStep({
  id: 'assess-binomial-readability-targets',
...
export const generateBinomialProblemVariantsWorkflow = createWorkflow({
  id: 'generate-binomial-problem-variants',
  inputSchema: binomialDistributionProblemSchema,
  outputSchema: workflowOutputSchema,
})
