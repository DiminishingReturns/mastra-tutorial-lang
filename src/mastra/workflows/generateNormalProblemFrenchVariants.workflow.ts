...
import { normalDistributionFrenchLanguageVariantAgent } from '../agents/normalDistributionFrenchLanguageVariantAgent';
...
const generatedVariantsWithCanonicalProblemSchema = z.object({
  canonicalProblem: normalDistributionProblemSchema,
...
const generateLanguageVariantsStep = createStep({
  id: 'generate-normal-distribution-french-language-variants',
...
`;
    ...
    const response =
      await normalDistributionFrenchLanguageVariantAgent.generate(prompt, {
        structuredOutput: {
...
export const generateNormalDistributionFrenchVariantsWorkflow = createWorkflow({
  id: 'generate-normal-distribution-french-variants',
  inputSchema: normalDistributionProblemSchema,
  outputSchema: workflowOutputSchema,
})
