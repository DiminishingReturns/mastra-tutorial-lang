...
import { languageVariantAgent } from '../agents/centralLimitTheoremLanguageVariantAgent';
...
import { centralLimitTheoremProblemSchema } from '../../problem-bank/schemas/centralLimitTheorem.schema';
...
const generatedVariantsWithCanonicalProblemSchema = z.object({
  canonicalProblem: centralLimitTheoremProblemSchema,
...
const generateLanguageVariantsStep = createStep({
  id: 'generate-central-limit-theorem-language-variants',

  inputSchema: centralLimitTheoremProblemSchema,

  outputSchema: generatedVariantsWithCanonicalProblemSchema,

  execute: async ({ inputData }) => {
    const prompt = `
Create three language versions of this central limit theorem problem.
...
const validateMathInvariantsStep = createStep({
  id: 'validate-central-limit-theorem-math-invariants',
...
const evaluateRegisterStep = createStep({
  id: 'evaluate-central-limit-theorem-register',
...
const computeReadabilityMetricsStep = createStep({
  id: 'compute-central-limit-theorem-readability-metrics',
...
const assessReadabilityTargetsStep = createStep({
  id: 'assess-central-limit-theorem-readability-targets',
...
export const generateCentralLimitTheoremProblemVariantsWorkflow =
  createWorkflow({
    id: 'generate-central-limit-theorem-problem-variants',
    inputSchema: centralLimitTheoremProblemSchema,
    outputSchema: workflowOutputSchema,
  })
