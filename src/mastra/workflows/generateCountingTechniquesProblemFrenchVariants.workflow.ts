...
import { countingTechniquesFrenchLanguageVariantAgent } from '../agents/countingTechniquesFrenchLanguageVariantAgent';
...
const generateLanguageVariantsStep = createStep({
  id: 'generate-counting-techniques-french-language-variants',
...
`;
    ...
    const response =
      await countingTechniquesFrenchLanguageVariantAgent.generate(prompt, {
        structuredOutput: {
...
const validateMathInvariantsStep = createStep({
  id: 'validate-counting-techniques-french-math-invariants',
...
const evaluateRegisterStep = createStep({
  id: 'evaluate-counting-techniques-french-register',
...
const computeReadabilityMetricsStep = createStep({
  id: 'compute-counting-techniques-french-readability-metrics',
...
const assessReadabilityTargetsStep = createStep({
  id: 'assess-counting-techniques-french-readability-targets',
...
export const generateCountingTechniquesFrenchVariantsWorkflow = createWorkflow({
  id: 'generate-counting-techniques-french-variants',
  inputSchema: countingTechniquesProblemSchema,
  outputSchema: workflowOutputSchema,
})
