...
import { discreteRandomVariableLanguageVariantAgent } from '../agents/discreteRandomVariableLanguageVariantAgent';
...
const generateLanguageVariantsStep = createStep({
  id: 'generate-discrete-random-variable-language-variants',
  ...
  execute: async ({ inputData }) => {
    const prompt = `
You generate three language-register versions of a canonical discrete random variable problem.
...
`;
    ...
    const response = await discreteRandomVariableLanguageVariantAgent.generate(
      prompt,
      {
        structuredOutput: {
...
const validateMathInvariantsStep = createStep({
  id: 'validate-discrete-random-variable-math-invariants',
...
const evaluateRegisterStep = createStep({
  id: 'evaluate-discrete-random-variable-register',
...
const computeReadabilityMetricsStep = createStep({
  id: 'compute-discrete-random-variable-readability-metrics',
...
const assessReadabilityTargetsStep = createStep({
  id: 'assess-discrete-random-variable-readability-targets',
...
export const generateDiscreteRandomVariableProblemVariantsWorkflow =
  createWorkflow({
    id: 'generate-discrete-random-variable-problem-variants',
    inputSchema: discreteRandomVariableProblemSchema,
    outputSchema: workflowOutputSchema,
  })
