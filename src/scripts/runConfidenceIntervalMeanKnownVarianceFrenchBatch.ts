...
import { generateConfidenceIntervalMeanKnownVarianceFrenchVariantsWorkflow } from '../mastra/workflows/generateConfidenceIntervalMeanKnownVarianceFrenchVariants.workflow';
async function main() {
  ...
  const outputPath = join(
    outputDirectory,
    'french-confidence-interval-mean-known-variance-batch-results-every-7th.json',
  );
